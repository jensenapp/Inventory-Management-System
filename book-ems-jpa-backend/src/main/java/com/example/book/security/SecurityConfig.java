...
public class SecurityConfig {
    ...
    public CommandLineRunner initData(RoleRepository roleRepository,
                                      ...
                                      BookRepository bookRepository) { // ✅ 修正 1：這裡成功補上了 BookRepository
        return args -> {
            // 初始化角色
            ...
            // ✅ 修正 2：確保 p1 和 p2 宣告在最外層，不會被 if 區塊吃掉
            Publisher p1 = publisherRepository.findById(1L).orElseGet(() -> {
                Publisher newP1 = new Publisher();
                newP1.setPublisherName("碁峰資訊");
                return publisherRepository.save(newP1);
            });

            Publisher p2 = publisherRepository.findById(2L).orElseGet(() -> {
                Publisher newP2 = new Publisher();
                newP2.setPublisherName("歐萊禮 (O'Reilly)");
                return publisherRepository.save(newP2);
            });

            // 書本初始化 (如果書本資料表是空的，就自動塞入 10 本書)
            if (bookRepository.count() == 0) {
                Book b1 = new Book(); b1.setTitle("Spring Boot 3 實戰開發"); b1.setAuthor("王大明"); b1.setPrice(650); b1.setPublishDate(LocalDate.parse("2023-11-15")); b1.setPublisher(p1); bookRepository.save(b1);
                ...
                Book b3 = new Book(); b3.setTitle("Docker 容器化架構指南"); b3.setAuthor("陳小華"); b3.setPrice(580); b3.setPublishDate(LocalDate.parse("2023-08-10")); b3.setPublisher(p1); bookRepository.save(b3);
                ...
                Book b6 = new Book(); b6.setTitle("Kubernetes 權威指南"); b6.setAuthor("李四"); b6.setPrice(900); b6.setPublishDate(LocalDate.parse("2023-12-01")); b6.setPublisher(p1); bookRepository.save(b6);
                Book b7 = new Book(); b7.setTitle("Python 網路爬蟲實戰"); b7.setAuthor("趙六"); b7.setPrice(450); b7.setPublishDate(LocalDate.parse("2022-11-28")); b7.setPublisher(p1); bookRepository.save(b7);
                Book b8 = new Book(); b8.setTitle("雲端架構設計與實務"); b8.setAuthor("林阿呆"); b8.setPrice(780); b8.setPublishDate(LocalDate.parse("2024-01-10")); b8.setPublisher(p2); bookRepository.save(b8);
